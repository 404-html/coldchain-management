...
class LocationsProxy extends \Locations implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'pkId', 'locationName', 'status', 'ccmLocationId', 'sdmsName', 'createdDate', 'modifiedDate', 'district', 'geoLevel', 'locationType', 'province', 'createdBy', 'modifiedBy', 'parent');
    }
